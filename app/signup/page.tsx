...
import { Loader2, ChefHat, Sparkles, Mail, Lock } from "lucide-react";
      ...
      <div className="w-full max-w-md bg-white rounded-3xl border-2 border-border hard-shadow-lg p-8 relative z-10">
        ...
        <form action={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full bg-tangerine hover:bg-tangerine-dark text-white font-bold py-3 px-6 rounded-xl border-2 border-coffee hard-shadow hover:translate-y-[1px] hover:shadow-none transition-all disabled:opacity-70 flex items-center justify-center gap-2"
          >
